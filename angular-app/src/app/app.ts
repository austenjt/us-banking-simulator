...
import { MoneySupply } from './components/money-supply/money-supply';

@Component({
  selector: 'app-root',
  imports: [Header, Customer, BankBranch, PrimaryDealer, FederalReserve, Treasury, TransactionLog, MoneySupply],
